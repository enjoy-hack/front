...
function TrackIntroTop() {
  return (
    <div className="flex flex-col px-6 pt-10 pb-14 bg-white max-w-5xl mx-auto">
      {/* 일러스트: 상단 중앙 정렬 */}
      ...
      {/* 제목 */}
      <h1 className="text-2xl font-semibold text-[#0056E1] mb-6">
        안녕하세요! 사용자님
        <br />
        ‘트랙제’에 대해 알아볼까요?
      </h1>
      ...
      <p className="text-sm text-[#A0A0A0] max-w-3xl leading-relaxed">
        ...
        실질적인 도움 이 될 수 있습니다. 트랙을 선택한다고 해서 반드시 해당
